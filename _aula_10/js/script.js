...
fetch("https://api.themoviedb.org/3/movie/popular?language=pt-br&page=1&api_key=dc060f164333ae3e04d1c86eec284d37")
    ...
    .then((dados) => {
        dados.results.map((filme) => {
            ...
            nos ajuda a quebrar um string com base na 
            posição do caracter e a quandidade de caracteres
            por exemplo 2024-06-29. para pegar os
            4 primeiros digitosusamos:
            substring(0,4)  
            */
